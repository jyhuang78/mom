...
if __name__ == "__main__":
    for df in [3, 1.02]:
        ...
        running_time = open("runing_time_" + str(df) + ".txt", "w")

        print("MoM")
        start_time = time.process_time()
        mom(round, d, K, theta, epsilon, v)
        end_time = time.process_time()
        print("MoM: " + str(end_time - start_time))
        running_time.write("MoM: " + str(end_time - start_time) + '\n')

        print("CRT")
        start_time = time.process_time()
        crt(round, d, K, theta, epsilon, v)
        end_time = time.process_time()
        print("CRT: " + str(end_time - start_time))
        running_time.write("CRT: " + str(end_time - start_time) + '\n')

        print("MENU")
        start_time = time.process_time()
        menu(round, d, K, theta, epsilon, v)
        end_time = time.process_time()
        print("MENU: " + str(end_time - start_time))
        running_time.write("MENU: " + str(end_time - start_time) + '\n')

        print("TOFU")
        start_time = time.process_time()
        tofu(round, d, K, theta, epsilon, v)
        end_time = time.process_time()
        print("TOFU: " + str(end_time - start_time))
        running_time.write("TOFU: " + str(end_time - start_time) + '\n')

        print("SupBMM")
        start_time = time.process_time()
        supbmm(round, d, K, theta, epsilon, v)
        end_time = time.process_time()
        print("SupBMM: " + str(end_time - start_time))
        running_time.write("SupBMM: " + str(end_time - start_time) + '\n')

        print("SupBTC")
        start_time = time.process_time()
        supbtc(round, d, K, theta, epsilon, v)
        end_time = time.process_time()
        print("SupBTC: " + str(end_time - start_time))
        running_time.write("SupBTC: " + str(end_time - start_time) + '\n')

        print("SupBMM_mom")
        start_time = time.process_time()
        supbmm_mom(round, d, K, theta, epsilon_mom, v_mom_bmm, varepsilon, n_tilde_bmm)
        end_time = time.process_time()
        print("SupBMM_mom: " + str(end_time - start_time))
        running_time.write("SupBMM_mom: " + str(end_time - start_time) + '\n')

        print("SupBTC_mom")
        start_time = time.process_time()
        supbtc_mom(round, d, K, theta, epsilon_mom, v_mom_btc, varepsilon, n_tilde_btc)
        end_time = time.process_time()
        print("SupBTC_mom: " + str(end_time - start_time))
        running_time.write("SupBTC_mom: " + str(end_time - start_time) + '\n')
