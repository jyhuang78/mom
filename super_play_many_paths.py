...
def mom(round, d, K, theta, epsilon, v):
    m = round ** (2 * epsilon / (1 + 3 * epsilon)) + 100
...
if __name__ == "__main__":
    ...
    for i, df in enumerate([1, 0.5]):
        ...
        #     supbmm_mom(round, d, K, theta, epsilon_mom, v_mom_bmm, varepsilon, n_tilde_bmm[i])
        #     supbtc_mom(round, d, K, theta, epsilon_mom, v_mom_btc, varepsilon, n_tilde_btc[i])
